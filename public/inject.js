...
var observer = new MutationObserver(function (mutations) {
    ...
    if (contentElement && !hasInjected) {
        ...
        setTimeout(() => {
            ...
            const bodyColor = btoa(window.getComputedStyle(document.body).backgroundColor)

            let iframe = document.createElement("iframe")
            iframe.src = chrome.runtime.getURL(`/index.html?theme=${theme}&body=${bodyColor}` + window.location.search.replace("?","&"))
